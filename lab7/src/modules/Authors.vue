...
const prepareCreateData = () => {
  ...
  if (!requestData.name) delete requestData.name;
  if (!requestData.surname) delete requestData.surname;
  return requestData;
}
...
<template>
  <div class="items-container">
    ...
    <apply-dialog
      ...
      :get-text="() => 'Вы уверены, что хотите удалить данного автора?'"
    ...
    <scroll-center-dialog
      ...
      :title="createDialogOpened ? 'Добавить нового автора' : 'Редактировать автора'"
    >
      ...
      <div class="form-content mt-4">
        ...
        >
          <template v-slot:label>
            <span class="field-label">Фамилия<span class="required-star">*</span></span>
          </template>
        </v-text-field>
        ...
        >
          <template v-slot:label>
            <span class="field-label">Имя<span class="required-star">*</span></span>
          </template>
        </v-text-field>
