...
export const useBooksStore = defineStore('books', {
  ...
  actions: {
    ...
    async loadBooksSelector () {
      this.selector = await sendRequest(urls.SELECTORS.BOOKS)
    },
    async loadItems() {
      this.loading.list = true
      let response = await sendRequest(urls.BOOKS.LIST, {}, {}, {
    ...
    async loadDetail(id) {
      ...
      this.detail = await sendRequest(urls.BOOKS.DETAIL, {}, {id})
      setTimeout(() => {
    ...
    async updateItem(id, data) {
      ...
      try {
        await sendRequest(urls.BOOKS.UPDATE, data, {id})
      } catch (e) {
        throw e
      } finally {
        setTimeout(() => {
    ...
    async createItem(data) {
      ...
      try {
        await sendRequest(urls.BOOKS.CREATE, data)
      } catch (e) {
        throw e
      } finally {
        setTimeout(() => {
    ...
    async deleteItem(id) {
      ...
      try {
        await sendRequest(urls.BOOKS.DELETE, {}, {id})
      } catch (e) {
        throw e
      } finally {
        setTimeout(() => {
